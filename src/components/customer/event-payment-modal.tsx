...
interface CustomerEventPaymentModalProps {
...
export function CustomerEventPaymentModal({
  event,
  isOpen,
  onClose,
  onConfirm,
}: CustomerEventPaymentModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Event booking payment recorded successfully!\n\nEvent: ${event.eventType.toUpperCase()}\nAmount: ₱${event.totalPrice}\n\nYour event is pending staff acceptance. We'll notify you once confirmed.`);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-gray-800">Pay at Event Venue</p>
                  <p className="text-sm text-gray-600">Pay when the event takes place</p>
                  <p className="text-xs text-blue-600 mt-1">Immediate confirmation at venue</p>
                </div>
              </button>
            </div>
          </div>
            ...
            <div className={`p-4 rounded-lg border-2 space-y-4 ${
              ...
              <div className={`text-sm p-3 rounded-lg ${selectedMethod === 'gcash' ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'}`}>
                ...
                <ol className="text-xs list-decimal ml-5 space-y-1">
                  ...
                  <li>Send ₱{event.totalPrice.toLocaleString()} to: <span className="font-mono font-bold">{selectedMethod === 'gcash' ? paymentConfig.gcashNumber : paymentConfig.mayaNumber}</span></li>
              ...
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 text-xs text-blue-800">
                ...
                <p>The staff will review and accept your event. Once accepted, you'll receive a confirmation. This usually takes a few hours.</p>
              </div>
            </div>
          )}
